...
- **Robotics:** Technical Member at [**AUXSPACE e.V.**](https://auxspace.de/), building the software architecture of an autonomous [**Rover**](https://github.com/AUXSPACEeV/rover)
...
Working on launch plans for **Live Streaming Coding Sessions** to showcase visible execution of complex tasks.
